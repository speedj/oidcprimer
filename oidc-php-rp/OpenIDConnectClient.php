...
class OpenIDConnectClient
{
     ...
     * @throws OpenIDConnectClientException
     */
    public function register($app, $redirect_uris, $response_types) {
        ...
        if ($redirect_uris === null) {
            $send_object->redirect_uris = array($this->getRedirectURL());
        }
        else {
            $send_object->redirect_uris = (array)$redirect_uris;	
        }

        if ($response_types === null) {
            $send_object->response_types = array("code");
        }
        else {
            $send_object->response_types = (array)$response_types;	
        }
